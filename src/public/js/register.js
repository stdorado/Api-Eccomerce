    ...
    registerForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          errorMessage.textContent = data.error || "Error al registrar. Inténtalo de nuevo más tarde.";
        }
      } catch (error) {
        console.error("Error al registrar:", error);
        errorMessage.textContent = "Error al registrar. Inténtalo de nuevo más tarde.";
      }
    });
  });