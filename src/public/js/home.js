  ...
  cardBody.innerHTML = `
    <div class="bg-white rounded-lg overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-105 group">
      ...
      <div class="p-4">
        ...
        <div class="mt-4 flex justify-between items-center">
        <button data-product-id="${product._id}" class="px-4 py-2 bg-cyan-600 hover:bg-orange-700 text-white rounded-md transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none comprarButton">
